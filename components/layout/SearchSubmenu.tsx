...
export const SearchSubmenu: React.FC<SearchSubmenuProps> = ({ className }) => {
  const pathname = usePathname();
  const t = useTranslations('search');

  const menuItems = [
    {
      section: t('submenu.quickAccess'),
      items: [
        { icon: TrendingUp, label: t('submenu.trending'), href: '/' },
        { icon: Clock, label: t('submenu.recent'), href: '/search/recent' },
        { icon: Star, label: t('submenu.favorites'), href: '/search/favorites' },
      ],
    },
    {
      section: t('submenu.categorySearch'),
      items: [
        { icon: Tag, label: t('submenu.devtools'), href: '/search/devtools' },
        { icon: Tag, label: t('submenu.productivity'), href: '/search/productivity' },
        { icon: Tag, label: t('submenu.design'), href: '/search/design' },
      ],
    },
  ];
